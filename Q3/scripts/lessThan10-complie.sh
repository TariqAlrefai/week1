...
node LessThan10/LessThan10_js/generate_witness.js "LessThan10/LessThan10_js/LessThan10.wasm" ./input.json ./witness.wtns
cd ..
echo "Inputs are valid, witness is generated"

# # Generate public.json
# snarkjs groth16 prove "LessThan10/circuit_0000.zkey" witness.wtns proof.json public.json
